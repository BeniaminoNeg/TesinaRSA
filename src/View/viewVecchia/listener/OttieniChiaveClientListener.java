 ...
 * 
 */
package View.viewVecchia.listener;
	...
	public void mouseClicked(MouseEvent e) {
		...
		case "Bob":
			...
			if (Bob != null) {
				...
				// Comunico all'utente che Bob non � stato inizializzato
				JOptionPane.showMessageDialog(home, "Bob non � stato inizializzato!", "Attenzione", JOptionPane.WARNING_MESSAGE);
			}
			break;
		case "Alice":
			...
			if (Alice != null) {
				...
				// Comunico all'utente che Alice non � stata inizializzata.
				JOptionPane.showMessageDialog(home, "Alice non � stata inizializzata!", "Attenzione", JOptionPane.WARNING_MESSAGE);
			}
			break;
