	...
	public void mouseClicked(MouseEvent e) {
		...
		case "Bob":
			...
			if (Alice != null) {
				...
				// Comunico a Bob che Alice non � stata inizializzata
		...
		case "Alice":
			...
			if (Bob != null) {
				...
				// Comunico a Alice che Bob non � stata inizializzata
				JOptionPane.showMessageDialog(home, "Bob non � stata inizializzato!", "Attenzione", JOptionPane.WARNING_MESSAGE);
			}
			break;
