...
public class AlgoritmoFrazioneContinuaDefaultStrategy implements IAlgoritmoFrazioneContinuaStrategy {
    ...
    public List<RisultatoIterazioneCalcoloFrazioneContinua> calcolaFrazioneContinua(Frazione frazione) {
		...
		*/
        ...
        // Se il rapporto tra numeratore e denominatore � strettamente minore di 1 devo aggiungere come primo 'ai' uno zero.
		...
		/* 
		*  Controllo se � presente almeno un elemento nella lista dei risultati dell'algoritmo euclideo. 
		*  Non � necessario effettuare questo controllo nel caso precedente, visto che due numeri hanno sempre
		...
		*/
		...
		/* 
		 * Se il rapporto tra numeratore e denominatore � strettamente minore di 1 devo eliminare il primo elemento 
		 * aggiunto alla lista delle frazioni in quanto � una frazione con il numeratore nullo.
		 */
        if (numeratore_su_denominatore.compareTo(BigInteger.ONE) < 0) {
...
//		}
    ...
    /**
     * Metodo per il calcolo del risultato per il calcolo della N pi� 1 - esima frazione continua.
     *
