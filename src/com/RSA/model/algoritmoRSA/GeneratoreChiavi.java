...
import com.RSA.model.algoritmoTestPrimalita.AlgoritmoTestPrimalitàFermatStrategy;
...
public class GeneratoreChiavi {
	/**
	 * Probabilit� che i numeri primi generati siano effettivamente primi, 
	 * con probabilit� pari ad (1/4)^_accuracy.
	 */
	...
	public static void generaChiavi(Client client, Boolean sicuro) {
		...
		if (sicuro == true) {
			// Il punto di partenza � un numero intero compreso tra 0 e 2^(_numBitQ-1).
...
//		System.out.println("D*E (mod fi_n): " + de.toString());
	 ...
	 * @param accuracy Precisione nella valutazione di primalit�.
	 */
