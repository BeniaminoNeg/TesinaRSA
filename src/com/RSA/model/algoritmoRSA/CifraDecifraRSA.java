...
/**
 * Questa classe rappresenta la macchina RSA, ovvero quella con la responsabilit� di cifrare e decifrare messaggi.
 * In particolare pu� prendere in input un messaggio in chiaro, ovvero un oggetto costituito da un terna (mittente,
 * destinatario, stringa), dove la stringa rappresenta il contenuto del messaggio vero e proprio, dando come
 * output una terna costituita da (mittente, destinatario, integer), dove integer � la stringa di input
...
public class CifraDecifraRSA {
    ...
    /**
     * Metodo per decifrare un messaggio, ottenendo cos� il messaggio in chiaro.
     *
